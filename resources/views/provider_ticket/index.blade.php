    ...
    <head>
        <meta charset="utf-8">
            <meta content="width=device-width, initial-scale=1.0" name="viewport">
                ...
                <link href="../layout/css/styleProvider.css" rel="stylesheet"/>
    ...
    <body class="sidebar-mini">
        <div id="app">
            <div class="main-wrapper">
                <div class="navbar-bg" style="background: -webkit-linear-gradient(left,#90F7EC ,#32CCBC);">
                </div>
            ...
            document.getElementById('logout-form').submit(); ">
                ...
                <index-provider :rol="'{{$RoleId}}'"></index-provider>
