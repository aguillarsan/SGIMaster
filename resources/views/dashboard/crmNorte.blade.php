<div class="col-lg-4 col-md-4 col-sm-12 " >
    <div class="card mt-4 box-shadow-new-card border-r-8 " >
        <div class="card-header card_dashboard_ticket  border-r-top" >
            <a href="/ticketblade/{{1}}" class="green_secondary_color">
                <h2 class="barlow semi_bold blanco boxBounce">
                  Norte
                </h2>
            </a>
            <div class="boxBounce" style="margin-top: 60px;margin-left: -78px;">
                @if($id == 21)
                <a class="barlow regular font-verde" href="/ticketExcelObrasCivilesCrm/{{1}}" style="font-size: 15px;">
                    <i class="fa fa-download">
                    </i>
                    < Descargar Reporte
                </a>
                @elseif($id ==14)
                <a class="barlow regular font-verde" href="/ticketExcelClimaCrm/{{1}}" style="font-size: 15px;">
                    <i class="fa fa-download">
                    </i>
                    Descargar Reporte
                </a>
                @else
                <a class="barlow regular font-verde" href="/ticketExcelCrm/{{1}}" style="font-size: 17px;">
                    <i class="fa fa-download">
                    </i>
                    Descargar Reporte
                </a>
