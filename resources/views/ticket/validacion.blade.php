  ...
  <div class="col-lg-12">
    ...
    <div class=" m-t-md" style="">
      ...
      <ol class="breadcrumb" style="background-color: rgba(0,0,0,0.0);color: white">
        ...
        <li  class="active barlow" style="color: white;">Tickets en validación </li>
...
<div class="tab_container">
  ...
  <input id="tab3"class="box" type="radio" name="tabs" checked>
  <label for="tab3"><i class="fa fa-check"></i><span>VALIDACIÓN {{$totaljefe}}</span></label>

  <a href="/fin">
    <input id=""class="box" type="radio" name="tabs">
    <label for=""><i class="fa fa-close"></i><span>FINALIZADAS {{$totalFin}}</span></label>
  </a>
  <section id="content3" class="tab-content"  style="border-radius: 6px;border-color: #f8ac59;background: rgba(0,0,0,0.5);color: white">
   <div class="row animated fadeIn">
    <div class="col-lg-12">
        ...
        <div class="table-responsive project-list">
          <table class="table table-striped table-hover">
            ...
            <tr style="background: rgba(0,0,0,0.0);" class="centro">
              <form action="/validacion" method="GET" enctype="multipart/form-data">
            ...
            <div>
             ...
             <td class="centro">
               <div >
                ...
                <div>
                  <button class="btn btn-primary" data-toggle="modal" data-target="#Inputacion3_{{$t->id}}"><i class="fa fa-plus"></i></button>
                </div>
                @endif
              </div>
            </td>
          ...
          <td>
           @can('J.validar')
           <form action="/cambioestado3/{{$t->id}}" method="POST" enctype="multipart/form-data">
            {{method_field('PUT')}}
          ...
          <button class="btn btn-danger btn-block" data-toggle="modal" data-target="#rechazo3_{{$t->id}}"><i class="fa fa-close"></i></button>
      ...
      <div class="modal inmodal" id="rechazo3_{{$t->id}}" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-sm">
          <div class="modal-content animated bounceInRight">
            ...
            <div class="modal-body">
              <form action="/rechazo3/{{$t->id}}" method="POST" enctype="multipart/form-data">
                {{method_field('PUT')}}
      ...
      <div class="modal inmodal" id="Inputacion3_{{$t->id}}" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-sm">
          <div class="modal-content animated bounceInRight">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
  ...
  {{$ticketjefe->appends(Request::only(['sitio','crm','usuario','cod_zona','estado','imputacion']))->links()}}
</div>
