  ...
  <div class="col-lg-12">
    ...
    <div class=" m-t-md" style="">
      ...
      <ol class="breadcrumb" style="background-color: rgba(0,0,0,0.0);color: white">
        ...
        <li  class="active barlow" style="color: white;">Halted crm {{strtolower($nombrecrm)}} </li>
...
<div class="tab_container">
  ...
  @endif
  <label for="tab1"><i class="fa fa-trello"></i><span>HALTED  </span>
    <div> {{$haltedTotal}}</div></label>
    ...
    @endif
    <label for="tab2"><i class="fa fa-list"></i><span>OPERATIVOS </span>
      <div> {{$operativoTotal}}</div>
    </label>
                    ...
                    <tbody>
                      <thead>
                        ...
                        <tr style="background: rgba(0,0,0,0.0);" class="centro">
                          <form action="/crmPop/{{$id}}" method="GET" enctype="multipart/form-data">
                            ...
                            <td>
                              ...
                              <div class="centro">
                                ...
                                <span class="label label-primary ">
                                  ...
                                  <td>
                                    <form action="/haltedUpdatecrm/{{$t->id}}/{{1}}/{{$cod_crm}}" method="POST" enctype="multipart/form-data">
                                      {{method_field('PUT')}}
                                  ...
                                  <div class="modal-dialog modal-sm">
                                    <div class="modal-content animated bounceInRight">
                                      ...
                                      <div class="modal-body">
                                        <form action="/rechazocrmHalted/{{$t->id}}/{{1}}/{{$cod_crm}}" method="POST" enctype="multipart/form-data">
                                          {{method_field('PUT')}}
                            ...
                            <table class="table table-striped table-hover">
                              ...
                              <tbody>
                                ...
                                <tr style="background: rgba(0,0,0,0.0);color: white">
                                  ...
                                  <td class="centro">
                                    <div>
                                      <span class="label label-success"style="font-size: 13px;">{{$t->id}}</span>
                                    </div>
