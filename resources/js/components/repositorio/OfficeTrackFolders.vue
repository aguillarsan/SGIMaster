                ...
                <section class="section">
                    <div class="section-header shadow-box-ag barlow bold">
                        <div class="breadcrumb-item active">
                            <a @click.prevent="getFoldersOfficeTrack" href="#" style="font-size: 18px;">
                                Office Track
                            </a>
                                  ...
                                  <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                            <div class="input-group">
                                                <input @keyup.prevent="getFoldersOfficeTrack" class="form-control" placeholder="Buscar" style="border-radius: 0px;height: 35px; " type="text" v-if="moduloId ==1 && idContentFold == ''" v-model="nombre"/>
...
export default {
    ...
    getFoldersOfficeTrack(){
        this.set_load();
        axios.get(`/officetrack/folders/data?nombre=${this.nombre}`).then((response) => {
            ...
            this.contenFold = [];
            this.moduloName = 'Office track';
            this.moduloId = 1;
            this.files = [];
            this.activitys = [];
            this.idContentFold = '';
            this.DetailsFolder = [];
            this.DefaultName = 'Office track';
    ...
    BackFold: function(id, name) {
        ...
        axios.get(`/officetrack/sub/folders?folderid=${id}`).then((response) => {
    ...
    GetContentFolder: function(folder) {
        this.set_load();
        axios.get(`/officetrack/sub/folders?folderid=${folder.id}`).then((response) => {
            this.folders = response.data.folder;
            this.files = response.data.files;
        }).finally(() => this.load_data = 2);
        if (this.moduloId == 2) {
