<template>
    <div>
        <div aria-hidden="true" class="modal inmodal" data-backdrop="static" id="EditPgpon" role="dialog" tabindex="-1">
            <div class="modal-dialog modal-sm">
                <div class="modal-content animated bounceInRight">
                    <div class="modal-header" style="background: -webkit-linear-gradient(#1e5e98 ,#0f0c29); height: 70px;">
                        <h5 class="modal-title" style="color: white">
                            Editar Proyecto GPON
                        </h5>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select class="form-control select" v-model="pgpon">
...
export default {
    ...
    mounted: function() { /* Agrega mounted y con el siguiente contenido */
        let self = this;
        EventBus.$on('sgc.modalPgopn', function (solicitud) {
    ...
    methods:{
        ...
        updateRequest:function(){
           if(this.pgpon != ''){
             axios.get(`/editPGpon?solicitud_id=${this.solicitud_id}&pgpon=${this.pgpon}`).then((response)=>{
              
                $('#EditPgpon').modal('hide');
                this.toastfunction()
                this.loadFunction()
                this.closefunction()
