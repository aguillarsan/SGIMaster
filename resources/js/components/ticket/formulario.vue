<template>
    <div>
        <form>
            <div aria-hidden="true" class="modal inmodal" id="formulario" data-backdrop="static" role="dialog"
                tabindex="-1">
                    ...
                    <div class="modal-content animated bounceInRight">
                        <div class="card" style="box-shadow: 0 0px 0px rgba(0, 0, 0, 0);">
                            <div class="modal-header"
                                ...
                                <button aria-label="Close" @click="CleandForm" class="close" data-dismiss="modal"
                                    type="button">
                            ...
                            <div class="modal-body">
                                <div class="card-body">
                                        ...
                                        <div class="col-12 col-lg-8 offset-lg-2">
                                            <div class="wizard-steps">
                                                <div class="wizard-step "
                                                    v-bind:class="step == 1 ?'wizard-step-active':''">
                                                ...
                                                <div class="wizard-step"
                                                    v-bind:class="step == 2 ?'wizard-step-active':''">
                                                    <div class="wizard-step-icon">
                                    ...
                                    <form class="wizard-content mt-2">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-12" id="stepOneDivOne">
                                                    <div class="form-group ">
                                                        ...
                                                        <div id="popcheck" style="display: none">
                                                            <div class="input-group">
                                                                <input class="form-control" disabled="true" name=""
                                                                    style="background-color:#015dff;color:white;"
                                                                    type="" v-bind:value="site_info_select" />
                                                                <div class="input-group-append">
                                                                    <div @click.prevent="changePop()"
                                                        ...
                                                        <div id="popSearch">
                                                            <div class="input-group">
                                                                <input class="form-control" id="inputSitio"
                                                                    name="datositio" placeholder="Buscar Sitio"
                                                                    style="position: relative;" type="text"
                                                                    v-model="datositio" v-on:keyup="BuscarSitio"
                                                                    value="" />
                                                                <div class="input-group-append">
                                                            ...
                                                            <div class="s_l">
                                                                <div :style="'width:'+input_width_form+'px'+';'"
                                                                    ...
                                                                    <div v-for="pop in pops">
                                                                        <a @click.prevent="selectdpop(pop.id,pop.nem_site,pop.nombre)"
                                                                            href="" id="selectpopvalue"
                                                                            style="color:black">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div id="tec_select_value" style="display: none">
                                                            <div class="input-group">
                                                                <input class="form-control" disabled="true" name=""
                                                                    style="background-color:#015dff;color:white;"
                                                                    type="" v-bind:value="tec_info_select" />
                                                                <div class="input-group-append">
                                                                    <div @click.prevent="cambiar_tecnologia()"
                                                                        class="input-group-text "
                                                                        style="cursor: pointer  ">
                                                                        <i class="fas fa-times boxBounce "
                                                                            style="color:#fc544b;font-size: 18px">
                                                        ...
                                                        <div id="tec_search">
                                                            <div class="input-group">
                                                                <input class="form-control" id="input_tec"
                                                                    placeholder="Buscar Tecnología" type="text"
                                                                    v-model="data_tec_search"
                                                                    v-on:keyup="BuscarTecnologia()" value="" />
                                                                <div class="input-group-append">
                                                                    <div class="input-group-text">
                                                                        <i class="fas fa-search">
                                                                        </i>
                                                        ...
                                                        <div id="list_tecologias" style="display: none">
                                                            <div class="s_l">
                                                                <div :style="'width:'+input_width_form_tec+'px'+';'"
                                                                    class="col-lg-12 col-md-4 col-sm-4 col-10 s_l_m">
                                                                    <div v-for="data_t in data_tec">
                                                                        <a @click.prevent="selectTech(data_t)" href=""
                                                                            id="select_tech_value" style="color:black">
                                                                            {{data_t.nem_tech}}
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select @change.prevent="deleteError"
                                                            class="form-control select barlow regular" id="motivo"
                                                            name="motivo" v-model="motivoId">
                                                    ...
                                                    <div class="form-group" id="TipoMantencion" style="display: none">
                                                        ...
                                                        <select @change.prevent="deleteError"
                                                            class="form-control select barlow regular" id="mantencion"
                                                            name="mantencion" v-model="mantencionId">
                                                            <option v-bind:value="mantencion.id"
                                                                v-for="mantencion in mantenciones">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea @keyup.prevent="deleteError" class="form-control"
                                                            id="descripcion" name="descripcion" placeholder=""
                                                            style="width: 100%; height: 100px;" v-model="descripcion">
                                                        </textarea>
                                                    ...
                                                    <div id="DivResago" style="display: none">
                                                        <div class="form-group">
                                                            ...
                                                            <select @change.prevent="deleteError"
                                                                class="form-control select" v-model="antiguedad">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select @change.prevent="deleteError"
                                                                class="form-control select" v-model="tipo_activo_id">
                                                                <option v-bind:value="1">
                                                                    Equipo
                                                                </option>
                                                                <option v-bind:value="2">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input @keyup.prevent="deleteError" class="form-control"
                                                                name="" type="text" v-model="desc_activo" />
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input @keyup.prevent="deleteError" class="form-control"
                                                                name="" type="text" v-model="cod_sap_activo_resago" />
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-12" id="stepOneDivTwoResago"
                                                    style="display: none">
                                                    <div class="form-group">
                                                        <label class="barlow semi_bold">
                                                            Cantidad *
                                                        </label>
                                                        <input @keyup.prevent="deleteError" class="form-control" name=""
                                                            style="width: 100%" type="number"
                                                            v-model="cant_activo_resago" />
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input @change.prevent="deleteError" class="form-control"
                                                            name="" type="date" v-model="fecha_puesta_marcha" />
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input @keyup.prevent="deleteError" class="form-control" name=""
                                                            type="text" v-model="pep_puesta_marcha" />
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input @keyup.prevent="deleteError" class="form-control" name=""
                                                            type="text" v-model="ework_pep_asociado" />
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-12" id="stepOneDivTwo">
                                                    <div class="form-group">
                                                        ...
                                                        <select @change.prevent="deleteError"
                                                            class="form-control select barlow regular" id="areas"
                                                            name="area" v-model="areaId" v-on:change="tecnica">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select @change.prevent="deleteError"
                                                            class="form-control select barlow regular " id="tecnicas"
                                                            name="tecnica" v-model="tecnicaId" v-on:change="equipo">
                                                            <option v-bind:value="tecnica.id"
                                                    ...
                                                    <div class="form-group" id="equiposId">
                                                        ...
                                                        <select @change.prevent="deleteError"
                                                            class="form-control select barlow regular" id="equipo"
                                                            name="equipo" v-model="equipoId">
                                                    ...
                                                    <div class="form-group" id="batery_yes_no" style="display: none">
                                                        <label class="barlow semi_bold">
                                                            Necesita baterías?
                                                        </label>
                                                        <select @change.prevent="check_response"
                                                            class="form-control select" v-model="need_batery">
                                                            <option :value="1">
                                                                Si
                                                            </option>
                                                            <option :value="2">
                                                        ...
                                                        <div id="error_need_batery" style="display: none">
                                                            <p style="color: red">
                                                                Favor seleccionar una opción
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div class="form-group" id="capacity_cells_div"
                                                        style="display: none">
                                                        <label class="barlow semi_bold" for="fechaInicio">
                                                            Capacidad de celdas *
                                                        </label>
                                                        <select @change.prevent="deleteError"
                                                            class="form-control select barlow regular" id="equipo"
                                                            name="equipo" v-model="capacitye_cell_id">
                                                            <option v-bind:value="capacityes_cell.id"
                                                                v-for="capacityes_cell in capacityes_cells">
                                                    ...
                                                    <div class="form-group" id="CantidadEquipo" style="display:none">
                                                        ...
                                                        <input @keyup.prevent="deleteError" class="form-control"
                                                            name="cantidad" style="width:100%" type="number"
                                                            v-model="cantidadEquipo" />
                                                    ...
                                                    <div class="form-group" id="total_bateri" style="display:none">
                                                        ...
                                                        <input @keyup.prevent="deleteErrorBatery" class="form-control"
                                                            name="cantidad" style="width:100%" type="number"
                                                            v-model="total_batery" />
                                        ...
                                        <div class="card" id="stepTwoneDivOne" style="display: none">
                                            <div class="card-body">
                                                <div class="file-upload"
                                                    style="margin-top: -20px; width: 90%;margin-left: ;">
                                                ...
                                                <ul class="list-unstyled">
                                                    <li class="media" style="margin-top: 10px;"
                                                        v-for="(file, key) in cotizaciones">
                                                        ...
                                                        <button @click.prevent="removeFileCotizaciones( key )"
                                                            class="btn btn-danger mr-3" style="margin-top: 18px; ">
                                                            <i class="fas fa-window-close blanco">
                                                            </i>
                                                        </button>
                                                        <input :id="key" :value="[file.name]" class="form-control mr-3"
                                                            name="" style="width: 20px;height:20px;margin-top: 20px; "
                                                            type="checkbox" v-model="cotizacion_select" />
                                                    </li>
                                                    <hr />
                                                </ul>
                                            </div>
                                            <div class="card-body">
                                                <div class="file-upload"
                                                    ...
                                                    <div class="image-upload-wrap">
                                                        <input class="file-upload-input" id="lpu" multiple="" ref="lpu"
                                                            type="file" v-on:change="handleLpuUploads()" />
                                                        <div class="drag-text">
                                                            <h2 class="barlow semi_bold" style="font-size: 20px;">
                                                                Lpu
                                                            </h2>
                                                ...
                                                <ul class="list-unstyled">
                                                    <li class="media" style="margin-top: 10px;"
                                                        ...
                                                        <button @click.prevent="removeFileLpu( key )"
                                                            class="btn btn-danger mr-3" style="margin-top: 18px; ">
                                                            <i class="fas fa-window-close blanco">
                                                            </i>
                                                        </button>
                                            ...
                                            <div class="card-body">
                                                <div class="file-upload"
                                                    style="margin-top: -20px; width: 90%;margin-left: ;">
                                                    <div class="image-upload-wrap">
                                                        <input class="file-upload-input" id="checklist" multiple=""
                                                            ref="checklist" type="file"
                                                            v-on:change="handleChecklistUploads()" />
                                                        <div class="drag-text">
                                                            <h2 class="barlow semi_bold" style="font-size: 20px;">
                                                                Chek list
                                                            </h2>
                                                ...
                                                <ul class="list-unstyled">
                                                    <li class="media" style="margin-top: 10px;"
                                                        ...
                                                        <button @click.prevent="removeFileCheckList( key )"
                                                            class="btn btn-danger mr-3" style="margin-top: 18px; ">
                                                            <i class="fas fa-window-close blanco">
                                                            </i>
                                                        </button>
                                            ...
                                            <div class="card-body">
                                                <div class="file-upload"
                                                    style="margin-top: -20px; width: 90%;margin-left: ;">
                                                    <div class="image-upload-wrap">
                                                        <input class="file-upload-input" id="pxqs" multiple=""
                                                            ref="pxqs" type="file"
                                                            v-on:change="handleFileUploadsPxq()" />
                                                        <div class="drag-text">
                                                            <h2 class="barlow semi_bold" style="font-size: 18px;">
                                                                PXQ
                                                            </h2>
                                                        </div>
                                                    </div>
                                                ...
                                                <ul class="list-unstyled">
                                                    <li class="media" style="margin-top: 10px;"
                                                        ...
                                                        <button @click.prevent="removeFilePxQ( key )"
                                                            class="btn btn-danger mr-3" style="margin-top: 18px; ">
                                                            <i class="fas fa-window-close blanco">
                                                            </i>
                                                        </button>
                                            ...
                                            <div class="card-body">
                                                <div class="image-upload-wrap">
                                                    <input class="file-upload-input" id="informefotografico" multiple=""
                                                        ref="informefotografico" type="file"
                                                        v-on:change="handleFileUploadsInformefotografico()" />
                                                    <div class="drag-text">
                                                ...
                                                <ul class="list-unstyled">
                                                    <li class="media" style="margin-top: 10px;"
                                                        v-for="(file, key) in informefotografico">
                                                        <i :class="getFileExtension(file.name) == 'pdf' ? 'far fa-file-pdf' : (getFileExtension(file.name) == 'xls' || getFileExtension(file.name) == 'xlsx' ? 'far fa-file-excel':(getFileExtension(file.name) == 'doc' || getFileExtension(file.name) == 'docx' ? 'far fa-file-word':( getFileExtension(file.name) == 'img' || getFileExtension(file.name) == 'jpg' || getFileExtension(file.name) == 'jpeg' ||  getFileExtension(file.name) == 'png' ? 'far fa-image':'far fa-file')))"
                                                            class="fas fa-file mr-3" style="font-size: 50px;">
                                                        </i>
                                                        <div class="media-body">
                                                        ...
                                                        <button @click.prevent="removeFileInformefotografico( key )"
                                                            class="btn btn-danger mr-3" style="margin-top: 18px; ">
                                                            <i class="fas fa-window-close blanco">
                                                            </i>
                                                        </button>
                                            ...
                                            <div class="card-body">
                                                <div class="file-upload"
                                                    style="margin-top: -20px; width: 90%;margin-left: ;">
                                                    <div class="image-upload-wrap">
                                                        <input class="file-upload-input" id="docdenuncia" multiple=""
                                                            ref="docdenuncia" type="file"
                                                            v-on:change="handleFileUploadsDocdenuncia()" />
                                                        <div class="drag-text">
                                                            <h2 class="barlow semi_bold" style="font-size: 20px;">
                                                                Documento denuncia
                                                            </h2>
                                                ...
                                                <ul class="list-unstyled">
                                                    <li class="media" style="margin-top: 10px;"
                                                        ...
                                                        <button @click.prevent="removeFileDocdenuncia( key )"
                                                            class="btn btn-danger mr-3" style="margin-top: 18px; ">
                                                            <i class="fas fa-window-close blanco">
                                                            </i>
                                                        </button>
                                                    ...
                                                    <hr />
                                                    <div class="form-inline barlow semi_bold">
                                                        <div class="col-lg-4">
                                                            <label>
                                                        ...
                                                        <div class="col-lg-4">
                                                            <label>
                                                                IMG:{{informefotografico.length}}
                                                            </label>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <label>
                                                                Doc.Denuncia:{{docdenuncia.length}}
                                                            </label>
                                                        </div>
                                                    </div>
                                                </ul>
                                        ...
                                        <div class="col-lg-12 col-md-6 col-sm-6 col-12" id="progressBarFileUpoad"
                                            style="display: none">
                        ...
                        <div class="modal-footer"
                            ...
                            <a @click.prevent="BackStepOne()" class="btn btn-icon icon-left btn-secondary btn-grey"
                                href="#" id="backStep1" style="display: none">
                                <i class="fas fa-arrow-left">
                                </i>
                                Atrás
                            </a>
                            <a @click.prevent="ValidateFormTicektStepOne()"
                                class="btn btn-icon icon-right btn-secondary btn-grey" href="#" id="btnNextStepOne">
                                Siguiente
                                <i class="fas fa-arrow-right">
                                </i>
                            </a>
                            <a @click.prevent="CreateTicket()" class="btn btn-icon icon-right btn-secondary btn-grey"
                                href="#" id="btnCreateTicket" style="display: none">
                                Finalizar
                                <i class="fas fa-arrow-right">
                                </i>
                            </a>
    ...
    export default {
        ...
        methods: {
            ...
            ValidateFormTicektStepOne: function () {
                ...
                if (this.motivoId == 3 || this.motivoId == 12) {
                ...
                if (this.motivoId == 3) {
                    if (this.form_complete == 1) {
                        ...
                        axios.post('/CrearTicket', formData, {
                            ...
                            this.sendMail(response.data.ticket_id)


                            if (this.rol == 29) {
                                axios.get(`/SendMailCrmTicket?sitio=${this.popid}&ticket=${response.data.ticket_id}&motivo=${this.motivoId}&descripcion=${this.descripcion}`)
                            }
                            this.BackStepOne();
                            this.CleandForm();
                        })
