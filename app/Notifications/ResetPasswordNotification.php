...
class ResetPasswordNotification extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line(Lang::get('Hola, se solicitó un restablecimiento de contraseña para tu cuenta asociada al correo' . $notifiable->getEmailForPasswordReset() . ', haz clic en el botón que aparece a continuación para cambiar tu contraseña.'))
