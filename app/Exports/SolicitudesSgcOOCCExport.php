...
class SolicitudesSgcOOCCExport implements FromCollection, WithHeadings, ShouldAutoSize, WithMapping
{
    /**
    ...
    public function collection()
    {
        ...
        ])->buscar()->whereIn('user_id', [21, 268, 267])
    ...
    public function map($solicitud): array
    {
        return [
            ...
            $solicitud->user_id != null ? $solicitud->user->name . ' ' . $solicitud->user->apellido : '' ,
