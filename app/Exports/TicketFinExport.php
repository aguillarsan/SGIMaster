...
class TicketFinExport implements FromCollection,  WithMapping , WithHeadings , ShouldAutoSize
{
    /**
    ...
    */
    ...
    {
       $ticket =  Ticket::with('user', 'area', 'tecnica', 'equipo', 'site.pop.comuna.zona', 'crm', 'estado','tipo_motivo')->where('estado_id',4)
    ...
    public function map($ticket): array {
    	return[
    		...
    		$ticket->fecha_inicio?substr($ticket->fecha_inicio,8,-8).'/'.substr($ticket->fecha_inicio,5,-12).'/'.substr($ticket->fecha_inicio,0,-15):'SIN FECHA DE INICIO',
