...
class IngenieriaExport implements FromCollection, WithHeadings, ShouldAutoSize, WithMapping, WithTitle
{
    /**
    ...
    public function map($solicitud): array
    {
        ...
        return [
            ...
            $solicitud->solicitud_das->first() ? str_replace(array('\'', '"'), '', trim($solicitud->solicitud_das->pluck("das"), '[]')) : '',
            $solicitud->tps->first() ? str_replace(array('\'', '"'), '', trim($solicitud->tps->pluck("nro_tp"), '[]')) : '',
            $solicitud->solicitud_montos->first() ? str_replace(array('\'', '"'), '', trim($solicitud->solicitud_montos->pluck("monto_solicitado_porcentaje"), '[]')) : '',
            $solicitud->solicitud_montos->first() ? trim($solicitud->solicitud_montos->pluck("monto_solicitado"), '[]') : '',
